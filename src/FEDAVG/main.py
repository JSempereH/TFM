...
train_dl, val_dl, test_dl = load_IID_datasets(num_clients=NUM_CLIENTS,
                                              dataset_name='CIFAR10')

client_1 = Client(client_name="Cliente 1",
                  net=Net(),
...
for i in range(NUM_CLIENTS):
    ...
    client = Client(client_name=f"Client {i+1}",
                    net=client_net,
...
#strategy = FedAvg()
strategy = FedProx(global_model=global_model,
                   mu = 0.01)
